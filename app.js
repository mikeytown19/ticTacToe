...
$("#a1").click(function() {
    if(a1 = "x"){
    document.getElementById("a1").className = "mystyle";
    }
});
$("#a2").click(function() {
    if(a2 = "x"){
    document.getElementById("a2").className = "mystyle";
}
});
$("#a3").click(function() {
    if(a3 = "x"){
    document.getElementById("a3").className = "mystyle";
    }
});
$("#b1").click(function() {
    if(b1 = "x"){
    document.getElementById("b1").className = "mystyle";
    }
});
$("#b2").click(function() {
    if(b2 = "x"){
    document.getElementById("b2").className = "mystyle";
}
});
$("#b3").click(function() {
    if(b3 = "x"){
    document.getElementById("b3").className = "mystyle";
    }
});
$("#c1").click(function() {
    if(c1 = "x"){
    document.getElementById("c1").className = "mystyle";
    }
});
$("#c2").click(function() {
    if(c2 = "x"){
    document.getElementById("c2").className = "mystyle";
}
});
$("#c3").click(function() {
    if(c3 = "x"){
    document.getElementById("c3").className = "mystyle";
    }
});
